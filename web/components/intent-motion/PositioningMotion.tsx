    ...
    >
      ...
      <div className="iosm-library-body" aria-hidden="true">
        ...
        <div className={stage >= 1 ? "iosm-grades is-visible" : "iosm-grades"}>
          ...
          <p>202 of the 318 we grade are C or weaker. That is on the page because it is true.</p>
        </div>
      </div>
      ...
      <figcaption className="iosm-sr-only" id="iosm-library-description">
        A diagram of the practice library: 323 protocols, 318 of them graded A to E — 15 A, 101 B, 121 C, 71 D and
