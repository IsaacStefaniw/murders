...
export const metadata: Metadata = {
  ...
  description:
    "All 177 practices in IntentNorth, each rated A to E for the strength of the research behind it, with what it will not do. 104 are rated Mixed or weaker and we say which.",
