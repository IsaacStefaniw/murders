...
export const metadata: Metadata = {
  ...
  description:
    "An iPhone app that turns 317 rated practices into a weekly plan for your training, food, sleep, habits, work, money and family — and changes the plan when your week changes.",
  icons: {
    icon: "/favicon.svg",
