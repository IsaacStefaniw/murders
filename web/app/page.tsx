  ...
  return (
    <main id="top">
      ...
      <section className="causality-section section-shell">
        <div className="causality-copy"><p className="section-kicker">THE PRODUCT IS THE CAUSALITY</p><h2>Before → because → after.</h2><p>A claim becomes proof when the visitor can see which signal changed which decision. The reason remains attached so adaptation never feels arbitrary.</p><div className="causality-proof"><ShieldCheck /><p><strong>Truth boundary:</strong> this diagram represents product behaviour, not a fabricated app screen. Broader cross-domain arbitration remains the direction.</p></div></div>
      ...
      <section className="founder-section section-shell"><div><p className="section-kicker">WHY INTENT EXISTS</p><h2>Built for people whose goals interact.</h2></div><p>“I did not need another dashboard telling me I was tired. I needed the plan to understand what the tiredness should change—without losing sight of family, work or the reason I was pursuing the goal.”</p><span>— Founder, INTENT OS</span></section>
