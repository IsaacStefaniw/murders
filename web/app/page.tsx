...
const heroPillars = [
  ...
  { lead: "It shows its evidence.", note: "Every practice rated A to E for the research behind it. We publish the weak ones — 205 of 321." },
];
...
const libraryStats = [
  ...
  },
  {
    ...
    note: "205 of the 321 are Mixed or weaker, and the app tells you which. A library where everything is excellent is a library that is not rating anything.",
  },
  {
  ...
  },
  {
    ...
    note: "282 of them carry a safety note in plain words, shown before you add anything to your week.",
  },
];
      ...
      <section className="library-section section-shell" id="library">
        ...
        <div className="rating-explainer">
          <div className="rating-copy">
            ...
            <p className="rating-honesty"><strong>205 of the 321 are rated C or weaker, and we say
        ...
        <div className="library-honesty">
          <ShieldCheck />
          <p><strong>Most of it is not an A, and it says so.</strong> Fifteen practices are grade A. One hundred and one are B. The remaining two hundred and five are C, D or E&mdash;useful, reasoned, and openly marked as weaker evidence. A system that graded everything highly would be easier to sell and worth less to trust.</p>
        </div>
      </section>
