...
const heroPillars = [
  ...
  { lead: "It shows its evidence.", note: "Every practice rated A to E for the research behind it, or told plainly why a grade would be the wrong thing to say. We publish the weak ones — 202 of the 318 we grade." },
];
...
const libraryStats = [
  ...
  },
  {
    ...
    note: "202 of the 318 we grade are Mixed or weaker, and the app tells you which. A library where everything is excellent is a library that is not rating anything. Five practices carry no grade at all — a fortnightly evening with your partner is not an unproven treatment, and calling it one would be the dishonest half of this.",
  },
  {
    label: "It names where the work came from.",
    note: "255 researchers and teachers are credited for the public work behind these practices. Credit, never endorsement.",
  },
  {
    label: "It tells you when not to do something.",
    note: "284 of them carry a safety note in plain words, shown before you add anything to your week.",
  },
];
      ...
      <section className="library-section section-shell" id="library">
        ...
        <div className="rating-explainer">
          <div className="rating-copy">
            ...
            <p className="rating-honesty"><strong>202 of the 318 we grade are rated C or weaker, and we say
        ...
        <div className="library-honesty">
          <ShieldCheck />
          <p><strong>Most of it is not an A, and it says so.</strong> Fifteen practices are grade A. One hundred and one are B. The remaining two hundred and two are C, D or E&mdash;useful, reasoned, and openly marked as weaker evidence. Five more carry no grade at all, because a letter would be the wrong thing to say about a booked evening with your partner. A system that graded everything highly would be easier to sell and worth less to trust.</p>
        </div>
      </section>
