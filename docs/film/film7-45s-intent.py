...
(async()=>{
 ...
 // 01 protocols
 show('lib-top');
 await copy({chap:'01',title:'Proven protocols, synthesised and rated',line:'323 practices.<br>318 graded A to E.',sub:'Every one credited to the public work behind it.'});
 ...
 await wait(2300);
 await copy({chap:'01',title:'Proven protocols, synthesised and rated',line:'284 carry a<br>plain-words safety line.'});
 await wait(2000);
 // choose one
 show('lib-card');
