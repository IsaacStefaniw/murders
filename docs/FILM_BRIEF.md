...
1. **Proven protocols, synthesised and rated.** 321 practices distilled
   from public evidence-based teaching, each graded A to E, each credited,
   282 with a plain-words safety line. Nobody else shows the grade.
...
| 2.6–4.6 | Library, top | 01 · PROVEN PROTOCOLS, SYNTHESISED AND RATED — *321 practices. Graded A to E. Every one credited.* | Attribution line under the phone, verbatim from the app |
| 4.6–9.0 | Library panning slowly through Morning light, Wind-down breathing, Caffeine cutoff | *Where it came from, how good the evidence is, and where it stops.* then *282 carry a plain-words safety line.* | Evidence grades and ⚠ lines visible as they pass |
...
- Numbers, counted from the code on the day: 321 practices; 15 A, 100 B,
  120 C, 70 D, 12 E; 282 with a safety line; 255 named researchers and
