...
1. **Proven protocols, synthesised and rated.** 323 practices distilled
   from public evidence-based teaching, each graded A to E, each credited,
   284 with a plain-words safety line. Nobody else shows the grade.
...
| 2.6–4.6 | Library, top | 01 · PROVEN PROTOCOLS, SYNTHESISED AND RATED — *323 practices. 318 graded A to E. Every one credited.* | Attribution line under the phone, verbatim from the app |
| 4.6–9.0 | Library panning slowly through Morning light, Wind-down breathing, Caffeine cutoff | *Where it came from, how good the evidence is, and where it stops.* then *284 carry a plain-words safety line.* | Evidence grades and ⚠ lines visible as they pass |
...
- Numbers, counted from the code on the day: 323 practices, 318 of them graded; 15 A, 101 B,
  121 C, 71 D, 10 E, and 5 carrying no grade because a grade would be the
  wrong thing to say about them; 284 with a safety line; 255 named researchers and
