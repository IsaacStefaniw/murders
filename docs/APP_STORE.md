...
> 317 practices, each rated A to E for the strength of the research behind it — 248 researchers and practitioners named for the ones their teaching popularised. 278 carry a plain-words safety line. Most of it is not an A, and it says so, because little of what anyone can teach you about your own life is.
>
...
prove a claim: 317/248/278 proves the grading is real, 5,376 proves no two
...
Every figure above is counted from the shipped code: 317 / 278 / 248 from
