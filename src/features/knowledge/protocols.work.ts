...
export const WORK_PROTOCOLS: Protocol[] = [
  {
    ...
    days: [3],
    durationMin: 120,
    anchor: { kind: 'workStart', offsetMin: 0, start: '09:00', windowMin: 30 },
    energy: 'morning',
    tier: 'could',
    duringWork: true,
  ...
  },
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 20,
    anchor: { kind: 'workStart', offsetMin: 150, start: '11:30', windowMin: 90 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
  ...
  },
  {
    ...
    days: [5],
    durationMin: 15,
    anchor: { kind: 'workStart', offsetMin: 360, start: '15:00', windowMin: 120 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
