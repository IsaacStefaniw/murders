...
export const RESEARCH_PROTOCOLS: Protocol[] = [
  ...
  },
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 5,
    anchor: { kind: 'workStart', offsetMin: 420, start: '16:00', windowMin: 180 },
    energy: 'any',
    tier: 'should',
    duringWork: true,
    anchorToWorkEnd: true,
  ...
  },
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 30,
    anchor: { kind: 'workStart', offsetMin: 210, start: '12:30', windowMin: 240 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
  ...
  // ── FEEDBACK ──────────────────────────────────────────────────────────
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 5,
    anchor: { kind: 'workStart', offsetMin: 300, start: '14:00', windowMin: 240 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
    neverNag: true,
  ...
  // ── JOB CRAFTING ──────────────────────────────────────────────────────
  {
    ...
    days: [0],
    durationMin: 25,
    anchor: { kind: 'workStart', offsetMin: 90, start: '10:30', windowMin: 240 },
    energy: 'morning',
    tier: 'could',
    duringWork: true,
  },
  {
    ...
    days: [6],
    durationMin: 20,
    anchor: { kind: 'workStart', offsetMin: 60, start: '10:00', windowMin: 240 },
    energy: 'morning',
    tier: 'could',
    duringWork: true,
  },
  ...
  // ── MEETINGS ──────────────────────────────────────────────────────────
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 5,
    anchor: { kind: 'workStart', offsetMin: 0, start: '09:00', windowMin: 480 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
    neverNag: true,
  },
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 15,
    anchor: { kind: 'workStart', offsetMin: 30, start: '09:30', windowMin: 300 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
    neverNag: true,
  },
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 5,
    anchor: { kind: 'workStart', offsetMin: 0, start: '09:00', windowMin: 300 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
    neverNag: true,
  },
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 10,
    anchor: { kind: 'workStart', offsetMin: 120, start: '11:00', windowMin: 420 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
    neverNag: true,
  ...
  // Five of twenty-two, about the fifth the contract asks for.
  {
    ...
    days: [2],
    durationMin: 5,
    anchor: { kind: 'workStart', offsetMin: 300, start: '14:00', windowMin: 300 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
    neverNag: true,
  },
  {
    ...
    days: [1, 2, 3, 4, 5],
    durationMin: 5,
    anchor: { kind: 'workStart', offsetMin: 60, start: '10:00', windowMin: 360 },
    energy: 'any',
    tier: 'could',
    duringWork: true,
    neverNag: true,
