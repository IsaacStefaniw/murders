...
export interface Dish {
  ...
  /**
   * Rough buying amounts for two, keyed by an entry in `keyIngredients`,
   * where the dish states one. The shopping list shows the amount beside
   * the item when it is here and the plain item when it is not — a dish
   * is never required to state amounts, and most only state the protein.
   * Written for two on purpose: the list says so, and scaling to the
   * household is a decision about how much the app should presume.
   */
...
export const DISHES: Dish[] = [
  {
    ...
    amounts: { 'chicken': '1 small whole bird, about 1.2 kg' },
  ...
  },
  {
    ...
    prepMin: 20,
    proteinAnchor: 'beef',
    amounts: { 'beef': '400 g, cut into strips' },
    tags: ['one_pan'],
  ...
  },
  {
    ...
    prepMin: 60,
    proteinAnchor: 'beef',
    amounts: { 'beef mince': '500 g', 'kidney beans': '1 tin' },
  ...
  },
  {
    ...
    prepMin: 40,
    proteinAnchor: 'chicken',
    amounts: { 'chicken': '500 g thigh fillets', 'coconut milk': '1 tin' },
  ...
  },
  {
    ...
    prepMin: 10,
    proteinAnchor: 'fish',
    amounts: { 'tuna': '2 tins', 'cannellini beans': '1 tin' },
  ...
  },
  {
    ...
    prepMin: 10,
    proteinAnchor: 'fish',
    amounts: { 'smoked mackerel': '2 fillets' },
  ...
  },
  {
    ...
    prepMin: 30,
    proteinAnchor: 'eggs',
    amounts: { 'eggs': '4', 'chickpeas': '1 tin' },
  ...
  },
  {
    ...
    prepMin: 35,
    proteinAnchor: 'dairy',
    amounts: { 'halloumi': '1 block, about 225 g' },
    tags: ['sheet_pan', 'one_pan'],
  ...
  },
  {
    ...
    prepMin: 30,
    proteinAnchor: 'dairy',
    amounts: { 'feta': '1 block, about 200 g' },
    tags: ['one_pan', 'sheet_pan'],
  ...
  },
  {
    ...
    amounts: { 'red lentils': '250 g', 'coconut milk': '1 tin' },
  ...
  },
  {
    ...
    prepMin: 25,
    proteinAnchor: 'legumes',
    amounts: { 'chickpeas': '2 tins', 'coconut milk': '1 tin' },
  ...
  },
  {
    ...
    amounts: { 'tofu': '1 block, about 300 g' },
    tags: ['one_pan'],
  ...
  },
  {
    ...
    amounts: { 'quinoa': '200 g', 'almonds': '50 g' },
  ...
  },
  {
    ...
    prepMin: 5,
    proteinAnchor: 'dairy',
    amounts: { 'greek yoghurt': '1 large tub, about 500 g' },
    tags: ['no_cook', 'store_cupboard'],
